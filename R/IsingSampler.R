...
# Requires at least two response options, all integer-valued (integer-valued
# doubles such as c(-1, 0, 1) are allowed; non-integers such as c(0, 0.5, 1)
# are not, as the Ising model is defined for discrete states).
